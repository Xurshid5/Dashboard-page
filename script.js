document.addEventListener("DOMContentLoaded", function () {
  ...
  function loadOverviewPage() {
    ...
    content.innerHTML = `
      <div style="font-size: 24px; font-weight: bold;">Welcome to Dashboard Overview</div>
      <p style="margin-top: 10px;">Select "Tickets" from the sidebar to see ticket management.</p>
    `;
  }
